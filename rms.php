    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header" style="background-color: red">
                ...
                <a class="navbar-brand" href=""><b>&nbsp;&nbsp;&nbsp; <img src="bavn.jpeg" height="30" width="40" alt="..." width="5%">BAVN SCHOOL</b></a>
            </div>
            <!-- Top Menu Items -->
            <ul class="nav navbar-right top-nav" style="background-color: red">
                <li class="dropdown">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse"  style="background-color: red">
            <?php 
            include 'db.php';
